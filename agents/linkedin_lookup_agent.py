...
def lookup(name:str)->str:
    ...
    template = """given the fullname of a person {name_of_person} I want you to get me a link to their linkedIn profile page.
    ...
    tools_for_agent = [
        Tool(
            ...
            description="useful for when you need to get linked Page URL"
        )
    ]
...
if __name__ == "__main__":
    linked_url = lookup(name="Saif Aslan")
    print(linked_url)